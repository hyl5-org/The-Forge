...
#define bchar(b, p)         bchare ((b), (p), '\0')
 ...
 extern char gEmptyStringBuffer[1];
 ...
 */
 extern BSTR_DECLARE_FN(bstring, bdynfromcstr, const char* pCStr);
 ...
 * global shared empty string buffer
 */
 extern BSTR_DECLARE_FN(bstring, bdynallocfromcstr, const char* str, int minCapacity);
 ...
 * global shared empty string buffer
 */
 extern BSTR_DECLARE_FN(bstring, bdynfromblk, const void* blk, int len, int minCapacity);
 ...
 * global shared empty string buffer
 */
 extern BSTR_DECLARE_FN(bstring, bdynfromstr, const bstring* b1, int minCapacity);
...
/* Ensures that underlying buffer is a c string */
 extern BSTR_DECLARE_FN(int, bmakecstr, bstring* b);
#define bmakecstr(b) BSTR_CALL(bmakecstr, b)

 extern BSTR_DECLARE_FN(int, bassign, bstring* a, const bstring* b);
#define bassign(a, b) BSTR_CALL(bassign, a, b)
 extern BSTR_DECLARE_FN(int, bassignmidstr, bstring* a, const bstring* b, int left, int len);
#define bassignmidstr(a, b, left, len) BSTR_CALL(bassignmidstr , a, b, left, len)
 extern BSTR_DECLARE_FN(int, bassigncstr, bstring* a, const char * str);
#define bassigncstr(a, str) BSTR_CALL(bassigncstr, a, str)
 extern BSTR_DECLARE_FN(int, bassignblk, bstring* a, const void * s, int len);
#define bassignblk(a, s, len) BSTR_CALL(bassignblk, a, s, len)

/* Destroy function */
 extern BSTR_DECLARE_FN(int, bdestroy , bstring* b);
#define bdestroy(b) BSTR_CALL(bdestroy, b)

/* Space allocation hinting functions */
 extern BSTR_DECLARE_FN(int, balloc, bstring* s, int len);
#define balloc(s, len) BSTR_CALL(balloc, s, len)
 extern BSTR_DECLARE_FN(int, ballocmin, bstring* b, int len);
...
/* Makes string dynamic and allocates max(current capacity, len) bytes for buffer*/
 extern BSTR_DECLARE_FN(int, bmakedynamic, bstring* b, int len);
...
/* Makes string dynamic and allocates minimal possible bytes to hold underlying string */
 extern BSTR_DECLARE_FN(int, bmakedynamicmin, bstring* b, int len);
...
/* Various standard manipulations */
 extern BSTR_DECLARE_FN(int, bconcat, bstring* b0, const bstring* b1);
#define bconcat(b0, b1) BSTR_CALL(bconcat, b0, b1)
 extern BSTR_DECLARE_FN(int, bconchar, bstring* b0, char c);
#define bconchar(b0, c) BSTR_CALL(bconchar, b0, c)
 extern BSTR_DECLARE_FN(int, bcatcstr, bstring* b, const char * s);
#define bcatcstr(b, s) BSTR_CALL(bcatcstr, b, s)
 extern BSTR_DECLARE_FN(int, bcatblk, bstring* b, const void * s, int len);
#define bcatblk(b, s, len) BSTR_CALL(bcatblk, b, s, len)
 extern BSTR_DECLARE_FN(int, binsert, bstring* s1, int pos, const bstring* s2, unsigned char fill);
#define binsert(s1, pos, s2, fill) BSTR_CALL(binsert, s1, pos, s2, fill)
 extern BSTR_DECLARE_FN(int, binsertblk, bstring* s1, int pos, const void * s2, int len, unsigned char fill);
#define binsertblk(s1, pos, s2, len, fill) BSTR_CALL(binsertblk, s1, pos, s2, len, fill)
 extern BSTR_DECLARE_FN(int, binsertch, bstring* s1, int pos, int len, unsigned char fill);
#define binsertch(s1, pos, len, fill) BSTR_CALL(binsertch, s1, pos, len, fill)
 extern BSTR_DECLARE_FN(int, breplace, bstring* b1, int pos, int len, const bstring* b2, unsigned char fill);
#define breplace(b1, pos, len, b2, fill) BSTR_CALL(breplace, b1, pos, len, b2, fill)
 extern BSTR_DECLARE_FN(int, bsetstr, bstring* b0, int pos, const bstring* b1, unsigned char fill);
#define bsetstr(b0, pos, b1, fill) BSTR_CALL(bsetstr, b0, pos, b1, fill) 
 extern int bdelete(bstring* s1, int pos, int len);
 extern BSTR_DECLARE_FN(int, btrunc, bstring* b, int n);
...
/* Scan/search functions */
 ...
 extern int biseqcaselessblk (const bstring* b, const void * blk, int len);
 ...
 extern int biseqblk (const bstring* b, const void * blk, int len);
...
#define bstrrchr(b,c) bstrrchrp ((b), (c), blength(b))
 ...
 extern BSTR_DECLARE_FN(int, bfindreplace, bstring* b, const bstring* find, const bstring* repl, int pos);
#define bfindreplace(b, find, repl, pos) BSTR_CALL(bfindreplace, b, find, repl, pos)
 extern BSTR_DECLARE_FN(int, bfindreplacecaseless, bstring* b, const bstring* find, const bstring* repl, int pos);
#define bfindreplacecaseless(b, find, repl, pos) BSTR_CALL(bfindreplacecaseless, b, find, repl, pos)

/* String split */
 extern BSTR_DECLARE_FN(bstring*, bsplit, const bstring* str, unsigned char splitChar);
#define bsplit(str, splitChar) BSTR_CALL(bsplit, str, splitChar)
 extern BSTR_DECLARE_FN(bstring*, bsplits, const bstring* str, const bstring* splitChars);
#define bsplits(str, splitChars) BSTR_CALL(bsplits, str, splitChars)
 extern BSTR_DECLARE_FN(bstring*, bsplitstr, const bstring* str, const bstring* splitStr);
...
typedef int(*BSplitCallbackFn) (void * parm, int ofs, int len);
 ...
 extern int bsplitscb(const bstring* str, const bstring* splitChars, int pos,
	BSplitCallbackFn cb, void * parm);
 extern int bsplitstrcb(const bstring* str, const bstring* splitStr, int pos,
	BSplitCallbackFn cb, void * parm);

/* String join */
 extern BSTR_DECLARE_FN(int, bjoin, bstring* out, const bstring inputs[], int count, const bstring* sep);
#define bjoin(out, inputs, count, sep) BSTR_CALL(bjoin, out, inputs, count, sep)
 extern BSTR_DECLARE_FN(int, bjoinblk, bstring* out, const bstring inputs[], int count, const void * sep, int sepLen);
#define bjoinblk(out, inputs, count, sep, sepLen) BSTR_CALL(bjoinblk, out, inputs, count, sep, sepLen)


/* Miscellaneous functions */
 extern BSTR_DECLARE_FN(int, bpattern, bstring* b, int len);
#define bpattern(b, len) BSTR_CALL(bpattern, b, len)
 ...
 extern BSTR_DECLARE_FN(int, bformat, bstring* b, const char * fmt, ...);
#define bformat(b, fmt, ...) BSTR_CALL(bformat, b, fmt OPT_COMMA_VA_ARGS(__VA_ARGS__))
 extern BSTR_DECLARE_FN(int, bformata , bstring* b, const char * fmt, ...);
#define bformata(b, fmt, ...) BSTR_CALL(bformata, b, fmt OPT_COMMA_VA_ARGS(__VA_ARGS__))
 extern BSTR_DECLARE_FN(int, bvformat, bstring* b, const char* fmt, va_list args);
#define bvformat(b, fmt, args) BSTR_CALL(bvformat, b, fmt, args)
 extern BSTR_DECLARE_FN(int, bvformata, bstring* b, const char* fmt, va_list args);
